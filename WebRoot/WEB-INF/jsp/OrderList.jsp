					...
					<s:iterator var="order" value="pageBean.list">
						<tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">
								<s:if test="#order.state == 1">
									<a href="${ pageContext.request.contextPath }/order_findByOid.action?oid=<s:property value="#order.oid" />"><font color="red">点击付款</font></a>
								</s:if>
						...
						<s:iterator var="orderItem" value="#order.orderItems">
							<tr>
								...
								<td><a  href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="#orderItem.product.pid"/>"><s:property value="#orderItem.product.pname" /></a></td>
