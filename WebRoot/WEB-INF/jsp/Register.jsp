...
<script>
	function checkForm(){
		...
		if(repassword!=password){
			document.getElementById("span3").innerHTML="前后两次密码不一致";
			return false;
		}
		...
		if(email==null||email==''){
			document.getElementById("span4").innerHTML="邮箱不能为空";
			return false;
		}
   }
	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="丰田制作">
			</a>
		</div>
	</div>
	<div class="span9">
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"  method="post" action="${pageContext.request.contextPath }/user_register.action" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
