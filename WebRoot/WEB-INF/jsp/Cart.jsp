...
<%@ include file="Menu.jsp" %>
					...
					<tbody><tr>
						...
						<tr>
							<td width="60">
								...
								<a href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="#c.product.pid"/>">
								<img src="${pageContext.request.contextPath }/<s:property value="#c.product.image"/>">
							</td>
							<td>
								<a  href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="#c.product.pid"/>"><s:property value="#c.product.pname"/></a>
							</td>
							<td>
		...
		<s:else>
		    <div class="span24">
			<div class="step step1">
				<span><h2><font color="red">亲，您还没有购物，请先去购物！</font></h2></span>
			</div>
			</div>
		</s:else>
	</div>
