...
<div class="container productList">
		...
		<div class="span18 last">
			...
			<form id="productForm" action="${pageContext.request.contextPath}/image/蔬菜 - Powered By Mango Team.htm" method="get">
				...
				<div id="result" class="result table clearfix">
						<ul>
						    <s:iterator var="pl" value="pageBean.list">
						          <li>
										<a href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="#pl.pid"/>">
											...
											<span class="price">
												商城价： ￥<s:property value="#pl.shop_price"/>
											</span>
										</a>
									</li>
							</s:iterator>		
	...
	<div class="pagination">
	     <s:if test="pageBean.page <=0">
		   <span>第 <s:property value="1"/>/<s:property value="pageBean.totalPage"/> 页</span>
		</s:if>
		<s:else>
